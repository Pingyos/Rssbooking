...
if (isset($_POST['submit'])) {
    ...
    $stmt = $mysqli->prepare("select * from db_res_sta where date = ? AND timeslot=?");
    ...
    if ($stmt->execute()) {
        ...
        if ($result->num_rows > 0) {
            ...
            $stmt = $mysqli->prepare("INSERT INTO db_res_sta (name,title,option_add,timeslot,email,tel,date) VALUES (?,?,?,?,?,?,?)");
            ...
            $sMessage .= "Tel: " . $tel . "\n";
            $sMessage .= "https://www.RSSbooking/editorenglishhours/calendar_res.php \n";
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select name="title" class="form-control" required>
                                    <option 2="">Research Consult</option>
                                    <option 3="">Statistic Consult</option>
                                </select>
                            </div>
                            <div class="form-group">
